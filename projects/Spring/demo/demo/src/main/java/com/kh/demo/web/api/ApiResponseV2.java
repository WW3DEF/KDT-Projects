...
public class ApiResponseV2<T> {
  ...
  public static <T> ApiResponseV2<T> createApiResponse(ApiResponseCode responseCode, T body){
    int totalCnt = 0;
    ...
    return new ApiResponseV2<>(new Header(responseCode.getRtcd(), responseCode.getRtmsg()), body, totalCnt);
  }
}
